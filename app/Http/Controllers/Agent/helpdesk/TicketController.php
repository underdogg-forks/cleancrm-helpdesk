        ...
        return \Datatables::of($tickets)
            ...
            ->editColumn('title', function ($tickets) {
                ...
                return "<div class='tooltip1' id='tool" . $tickets->id . "'>
                        ...
                        [$tickets->id]) . "'>" . $string . "&nbsp;<span style='color:green'>" . $thread_count . "</span>
                            </a> <span><i style='color:green' title='" . Lang::get('lang.ticket_created_source',
                        ['source' => $source]) . "' class='" . $css . "'></i></span>" . $collabString . $attachString . $due . $tooltip_script .
            ...
            ->editColumn('ticket_number', function ($tickets) {
                return "<a href='" . route('ticket.thread',
                        [$tickets->id]) . "' class='$" . ucfirst($tickets->priority) . "*' title='" . Lang::get('lang.click-here-to-see-more-details') . "'>#" . $tickets->ticket_number . '</a>';
            })
            ->editColumn('c_uname', function ($tickets) {
                ...
                return "<a href='" . $url . "' title='" . Lang::get('lang.see-profile1') . ' ' . $name . '&apos;' . Lang::get('lang.see-profile2') . "'><span style='color:#508983'>" . str_limit($name,
            ...
            ->editColumn('a_uname', function ($tickets) {
                if ($tickets->assigned_to == null && $tickets->name == null) {
                    ...
                    if ($tickets->assigned_to != null) {
                        ...
                        return "<a href='" . $url . "' title='" . Lang::get('lang.see-profile1') . ' ' . $assign . '&apos;' . Lang::get('lang.see-profile2') . "'><span style='color:green'>" . mb_substr($assign,
                                0, 30, 'UTF-8') . '</span></a>';
                    } else {
                        $url1 = '#';

                        return "<a href='" . $url1 . "' title='" . Lang::get('lang.see-profile1') . ' ' . ucfirst($tickets->name) . '&apos;' . Lang::get('lang.see-profile2') . "'><span style='color:green'>" . mb_substr(ucfirst($tickets->name),
                                0, 30, 'UTF-8') . '</span></a>';
                    }
                }
            })
    ...
    public function post_newticket(CreateTicketRequest $request, CountryCode $code, $api = false)
    {
        try {
            ...
            if ($result[1]) {
                ...
                if ($api != false) {
                    return response()->json(['error' => Lang::get('lang.failed-to-create-user-tcket-as-mobile-has-been-taken')],
                        500);
                }
